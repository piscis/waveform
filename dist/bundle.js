...
/***/ function(module, exports, __webpack_require__) {
	...
	var SpectrumRenderer_1 = __webpack_require__(157);
	var indexHTML = __webpack_require__(159);
	var WaveformWidget = (function (_super) {
	    __extends(WaveformWidget, _super);
	    function WaveformWidget(props) {
	        _super.call(this, props);
	        this.spectrum = null;
	        this.displayName = 'WaveformWidget';
	        this.foo = 44;
	    }
	    WaveformWidget.prototype.componentDidMount = function () {
	        var dNode = React.findDOMNode();
	        this.spectrum = new SpectrumRenderer_1.default(dNode, true);
	    };
	    WaveformWidget.prototype.componentWillUnmount = function () {
	    };
	    WaveformWidget.prototype.render = function () {
	        return React.createElement("div", null, "Hello world! ", this.props.name, " ");
	    };
	    return WaveformWidget;
	})(React.Component);
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = WaveformWidget;
...
/***/ function(module, exports, __webpack_require__) {
	...
	/// <reference path="../typings/tsd.d.ts" />
	var SpectrumResizeHandler_1 = __webpack_require__(158);
	var SpectrumRenderer = (function () {
	    function SpectrumRenderer(domElm, isResizeable) {
	        if (isResizeable === void 0) { isResizeable = true; }
	        this.domElm = domElm;
	        ...
	        if (this.isResizeable) {
	            this.resizeHandler = new SpectrumResizeHandler_1.default(this.renderer, this.camera);
	        }
	    }
	    SpectrumRenderer.prototype.onUpdate = function (data) {
	        this.data = data;
	    };
	    SpectrumRenderer.prototype.animate = function () {
	        requestAnimationFrame(this.animate);
	        this.redraw();
	    };
	    SpectrumRenderer.prototype.redraw = function () {
	        this.clearLine(this.line);
	        this.line = this.createLine();
	        this.addLine(this.line);
	        this.renderer.render(this.scene, this.camera);
	    };
	    SpectrumRenderer.prototype.unmount = function () {
	        return true;
	    };
	    SpectrumRenderer.prototype.clearLine = function (line) {
	        this.scene.remove(line);
	        this.line = null;
	    };
	    SpectrumRenderer.prototype.createLine = function () {
	    ...
	    SpectrumRenderer.prototype.addLine = function (line) {
	        this.scene.add(line);
	    };
	    return SpectrumRenderer;
	})();
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = SpectrumRenderer;
...
/***/ function(module, exports) {
	...
	/// <reference path="../typings/tsd.d.ts" />
	var SpectrumResizeHandler = (function () {
	    function SpectrumResizeHandler(renderer, camera) {
	        this.renderer = renderer;
	        this.camera = camera;
	        this.isSubscribed = false;
	    }
	    SpectrumResizeHandler.prototype.onResize = function () {
	        this.renderer.setSize(window.innerWidth, window.innerHeight);
	        this.camera.aspect = window.innerWidth / window.innerHeight;
	        this.camera.updateProjectionMatrix();
	    };
	    SpectrumResizeHandler.prototype.start = function () {
	        if (this.isSubscribed) {
	            window.addEventListener('resize', this.onResize, false);
	            this.isSubscribed = true;
	        }
	    };
	    SpectrumResizeHandler.prototype.stop = function () {
	        window.removeEventListener('resize', this.onResize, false);
	        this.isSubscribed = false;
	    };
	    SpectrumResizeHandler.prototype.init = function () {
	        var _this = this;
	        this.start();
	        return {
	            stop: function () {
	    ...
	    return SpectrumResizeHandler;
	})();
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = SpectrumResizeHandler;
